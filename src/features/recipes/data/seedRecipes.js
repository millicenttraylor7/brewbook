import icedLatteImage from "../../../assets/Iced-latte.png";
import frenchPressImage from "../../../assets/french-press.png";
...
export const seedRecipes = [
  {
    ...
    ingredients: [
      { id: "ing-1", item: "Espresso", amount: 2, unit: "shots" },
      { id: "ing-2", item: "Milk", amount: 8, unit: "oz" },
      { id: "ing-3", item: "Ice", amount: 1, unit: "cup" },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { id: "ing-4", item: "Coffee (coarse grind)", amount: 4, unit: "tbsp" },
      { id: "ing-5", item: "Hot water", amount: 16, unit: "oz" },
    ],
    steps: [
